...
export const onload = () => {
  ...
  const translateX = program.uniforms.translateX;
  const translateY = program.uniforms.translateY;
  ...
  pane.on('change', e => {
    translateX.value = PARAMS.translateX;
    translateY.value = PARAMS.translateY;
