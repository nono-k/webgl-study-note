...
export const onload = () => {
  ...
  const strength = program.uniforms.strength;
  ...
  pane.addBinding(PARAMS, 'ambient', { min: 0.0, max: 1.0, step: 0.01 });
  pane.addBinding(PARAMS, 'strength', { min: 0.1, max: 10, step: 0.1 });
